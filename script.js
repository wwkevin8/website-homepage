const translations = {
  "zh-CN": {
    ...
    teamVivianRole: "学生公寓顾问",
    teamVivianText: "作为左邻右里的创始人，Vivian 长期生活在诺丁汉，熟悉本地租房环境、学生公寓资源和留学生在落地阶段最真实的生活需求。她希望把多年在当地积累的经验、判断和服务节奏，转化为更稳定、更可靠的订房支持，也让左邻右里始终保持贴近学生的服务视角。",
    team2Name: "Kevin",
    team2Role: "学生公寓顾问",
    team2Text: "Kevin 是团队里的主要顾问人员，也是很多同学在咨询阶段最先建立信任的人。长期深度对接诺丁汉大大小小的学生公寓后，他对不同公寓的定位、区域氛围、价格区间、合同节奏、优缺点差异以及学生真正关心的问题都非常熟悉。毕业于诺丁汉大学电子与电气工程专业、常驻 Park 校区的他，不仅专业、靠谱，也很有亲和力，能够把复杂的信息讲得清楚、把选择逻辑梳理明白，帮助同学更高效地找到真正适合自己的房子。",
    team3Name: "Firo",
    team3Role: "学生公寓顾问",
    team3Text: "Firo 也是团队里的租房顾问之一，主要负责日常沟通、咨询承接和后续协助跟进。他的沟通方式自然、亲和，不会给人距离感，比较容易让学生在咨询过程中放松下来。对于公寓基础信息、入住节奏和常见问题，他也能够提供清晰直接的说明，是团队里很稳定的一位协助型顾问。",
    team4Name: "小妮",
    team4Role: "学生公寓顾问",
    team4Text: "小妮同样是团队里的租房顾问人员。作为学校大使馆成员，她对学生需求比较熟悉，也更了解大家在入住沟通、信息理解和生活适应阶段常见的细节问题。她更擅长从学生视角去看待问题，帮助大家把一些看似琐碎、但实际很影响体验的事情提前理顺。",
    ...
    outlookQuoteText: "未来，我们会继续深耕诺丁汉本地主流公寓资源，提升团队响应效率，扩展更多贴近学生真实生活的福利与活动，并进一步把咨询、订房、入住、售后、节日陪伴和本地生活支持之间的连接做得更顺。我们希望左邻右里不仅是一个能帮学生订房的团队，更是一个在关键时刻值得被信任、愿意长期陪伴学生成长的本地服务品牌。",
  ...
  en: {
    ...
    teamVivianRole: "Student Accommodation Advisor",
    teamVivianText: "As the founder of NGN, Vivian has lived in Nottingham for many years and knows the local housing environment, residence resources and the real needs students face during the settling-in stage. She hopes to turn that long-term local experience, judgement and service rhythm into more dependable booking support while keeping NGN closely aligned with student needs.",
    team2Name: "Kevin",
    team2Role: "Student Accommodation Advisor",
    team2Text: "Kevin is one of the team's lead advisors and often the person students build trust with first during the consultation stage. Through long-term, close work with student residences across Nottingham, he is highly familiar with residence positioning, area atmosphere, pricing, contract timing, strengths and weaknesses, and the questions students genuinely care about. With his University of Nottingham EEE background, Park Campus experience, professionalism, reliability and strong approachability, he is especially effective at turning complex housing choices into clear and practical guidance.",
    team3Name: "Firo",
    team3Role: "Student Accommodation Advisor",
    team3Text: "Firo is also one of the team's accommodation advisors, mainly supporting day-to-day communication, enquiry handling and follow-up coordination. His communication style is natural and approachable, which helps students feel more relaxed during the process. He can also give clear explanations around basic residence information, move-in timing and common questions, making him a steady supporting advisor within the team.",
    team4Name: "Xiao Ni",
    team4Role: "Student Accommodation Advisor",
    team4Text: "Xiao Ni is also part of the accommodation advisory team. As a school ambassador member, she is familiar with student needs and the kinds of details that often come up during move-in, communication and everyday adjustment. She is especially good at looking at situations from a student perspective and helping make small but important issues easier to manage in advance.",
    ...
    outlookQuoteText: "Looking ahead, we want to keep deepening our Nottingham residence network, improving team responsiveness, expanding benefits and activities that reflect real student life, and making the connection between enquiry, booking, move-in, aftercare, seasonal activities and local support much smoother. Our goal is not only to be a team that helps students secure accommodation, but to become a trusted local brand that students can rely on at important moments throughout their time in Nottingham.",
