const translations = {
  "zh-CN": {
    ...
    calcEndDate: "预期结束日期",
    calcEndDateHelp: "预期结束日期同时作为送回 / 取回日期。返还服务在任何情况下都需至少提前 7 天预约。",
...
function initStorageCalculator(activeLang) {
  ...
  function getCustomerFormData() {
    ...
    return {
      ...
      wechatId: bookingForm.querySelector('[name="wechatId"]')?.value.trim() || "",
