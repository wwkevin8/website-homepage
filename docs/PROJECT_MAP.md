...
| `/api/public/transport-join-preview` | public aggregate -> `transport-join-preview.js` | POST | Preview joining a pickup/carpool request; matching and time-gap warnings compare actual `flight_datetime` values | Yes | No | `transport_requests`, `transport_groups`, `transport_group_members` |
| `/api/public/transport-join-submit` | public aggregate -> `transport-join-submit.js` | POST | Submit join request and create/add transport request without a public preferred-time field; matching uses actual `flight_datetime` | Yes | No | `transport_requests`, `transport_groups`, `transport_group_members` |
